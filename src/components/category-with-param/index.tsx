...
const CategoryParam: FC<Prop> = ({type}) => {
  ...
  const { isLoading, error, data } = useQuery(
    ...
    () => {
      ...
      return fetch(`http://localhost:4321/api/v1/products/search?category=${type}&request=buyRequest`, {headers: {Authorization: "Basic anVkanNkc3Vfc29zOTpsZG85ZHNqbnM5OA=="}})
        .then((res) => {
          return res.json()})
    }, 
    { 

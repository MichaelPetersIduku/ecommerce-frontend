...
({side, right}) => {
	...
	const { isLoading, isError } = useQuery('getAllrecord', () => {
		return fetch(`http://localhost:4321/api/v1/products?request=buyRequest`, {headers: {Authorization: "Basic anVkanNkc3Vfc29zOTpsZG85ZHNqbnM5OA=="}})
			.then((res) => res.json())
	}, 
	{
		...
		onSuccess: async (data: any) => {
			...
			const response = await fetch(`http://localhost:4321/api/v1/products/category`, {headers: {Authorization: "Basic anVkanNkc3Vfc29zOTpsZG85ZHNqbnM5OA=="}});
